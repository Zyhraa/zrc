   ...
   <div class="bg-image test" style="background-image: url('assets/images/home1.png'); background-size:cover; background-repeat: no-repeat;">
      ...
      <div class="jasa">
         ...
         <div class="whyus mt-5 pt-5 mb-5 pb-5">
            <h1 class="mb-5">Kenapa pilih kami?</h1>
            <p class="whydesc col-8 offset-2 mb-5 pb-5">Karena kami adalah pilihan utama dalam memberikan solusi inovatif kreatif dan terpercaya, memberikan kontribusi yang melebihi dari harapan klien atau mitra melalui pelayanan istimewa secara profesional dan intergritas penuh.</p>
         </div>
      </div>
   </div>
