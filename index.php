...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=IM+Fell+Great+Primer+SC&family=News+Cycle:wght@400;700&family=Playfair+Display:wght@600;700;800&display=swap" rel="stylesheet">
    <!-- font -->
    ...
    <div class=" container-fluid">
        ...
        <div class="container">
            <div class="column center p-5 m-5">
                ...
                <a class="mt-5 btna text-decoration-none" style="color:white;" href="home.php">
                    <div class="offset-5 col-2 px-5 py-3 btnku">About Us</div>
                </a>
