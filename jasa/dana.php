...
<body>
   ...
   <div class="all">
      <div class="d-flex justify-content-center flex-column mt-5 pt-5 tengah">
         <h1 class="judulevent mt-5">Aktivitas Manajemen Data</h1>
         ...
         <div class="eventabout col-6 offset-3">
            <p>pendanaan untuk pembayaran kegiatan event kecil maupun besar yang diselenggarakan secara pribadi maupun perusahaan dengan kepercayaan yang bisa di andalkan</p>
         </div>
      </div>
